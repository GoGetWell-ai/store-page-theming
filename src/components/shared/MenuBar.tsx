        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-black font-bold text-xl">goGetwell.ai</span>
            </div>
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              <Link
                ...
                className={`${
                    isActive('/')
                      ? 'border-b-2 border-white text-white font-semibold bg-primaryMild'
                      : 'border-transparent text-white/70 hover:border-primaryMild hover:text-white'
          ...
          <div className="flex items-center">
            ...
            <div className="-mr-2 flex items-center sm:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-primarySubtle hover:text-black hover:bg-primaryDeep focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black"
              >
