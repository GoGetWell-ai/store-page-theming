...
import { HiOutlineSparkles, HiOutlineCalendar, HiOutlineBadgeCheck, HiOutlineUserCircle } from 'react-icons/hi'
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-2 lg:order-1">
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg z-20">
                                <div className="flex items-center space-x-3">
                                    <div className="flex -space-x-2">
                                        {[1, 2, 3].map((_, index) => (
                                            <div key={index} className="w-8 h-8 rounded-full bg-purple-200 border-2 border-white flex items-center justify-center">
                                                <HiOutlineUserCircle className="h-4 w-4 text-purple-600" />
                                            </div>
                                        ))}
                                    </div>
                                    <div className="text-xs">
                                        <p className="font-semibold">3,500+ satisfied clients</p>
                        ...
                        <div className="mt-10 bg-white p-6 rounded-xl shadow-md border-l-4 border-pink-400">
                            <div className="flex items-start">
                                <div className="text-4xl text-pink-300 mr-4">"</div>
                                <div>
                                    <p className="italic text-gray-700 mb-4">
                                        The transformation wasn't just physical. It gave me a new confidence 
                                        I never thought possible. The entire team made me feel safe and cared for.
                                    </p>
                                    <p className="font-medium text-gray-900">— Sarah M., 34</p>
                                    <p className="text-sm text-gray-500">Facial Contouring & Rhinoplasty</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <p className="text-lg text-gray-600 mb-8">
                            Our exclusive network of world-class cosmetic surgeons combines artistry with 
                            medical expertise to deliver natural-looking, transformative results tailored 
                            to your unique features and aspirations.
                        </p>
                        ...
                        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-md">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {popularProcedures.map((procedure, index) => (
                                    <Card key={index} className="border-purple-100 hover:border-purple-300 transition-colors cursor-pointer">
                                        <div className="p-4">
                                            <div className="flex items-center space-x-3">
                                                <div className="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center">
                                                    <HiOutlineSparkles className="h-4 w-4 text-pink-600" />
                                                </div>
                                                <p className="font-medium text-gray-700">{procedure}</p>
                                            </div>
                                        </div>
                                    </Card>
                                ))}
                            ...
                            <p className="mt-4 text-center text-sm text-gray-500">
                                Each procedure is tailored to your unique features and desired outcomes
                            </p>
                        </div>
                    </div>
                </div>
