                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-lg text-gray-600 mb-8">
                            Our network of world-renowned transplant centers
                            offers hope and healing through innovative organ
                            transplantation procedures. From evaluation to
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                            <h3 className="text-lg font-semibold text-gray-800 mb-4">
                                Our Transplant Success
                            </h3>
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                {transplantTypes.map((type, index) => (
                                    <div key={index} className="text-center">
                                        <div
                                            className={`w-12 h-12 rounded-full ${type.color} mx-auto flex items-center justify-center mb-2`}
                                        >
                            ...
                            <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl border-4 border-white">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-red-900/80 to-transparent p-6">
                                    <p className="text-white font-medium">
                                        Our transplant teams work around the
                                        clock to save lives
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">
                                                Cross-border transplant support
                                            </p>
                                        </div>
                                    </div>
                                </div>
