                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative flex justify-center items-center">
                            ...
                            <div className="absolute w-[120%] h-[120%] bg-green-200 rounded-full opacity-30 animate-blob"></div>
                            <div className="absolute w-[110%] h-[110%] bg-green-300 rounded-full opacity-20 animate-float-circle"></div>
                            <div className="absolute w-[105%] h-[105%] bg-green-400 rounded-full opacity-15 animate-pulse-slow"></div>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative z-10 animate-float-slow">
                                    ...
                                    <div className="absolute -top-4 -right-4 w-8 h-8 bg-green-500 rounded-full animate-float-right"></div>
                                    <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-green-600 rounded-full animate-float-left"></div>
                                    <div className="absolute top-1/4 -left-6 w-10 h-10 bg-green-300 rounded-full animate-float-delay"></div>
                                    <div className="absolute bottom-1/4 -right-6 w-7 h-7 bg-green-400 rounded-full animate-float"></div>
                                    
                                    {/* Small decorative elements */}
                                    <div className="absolute top-1/2 -right-3 w-4 h-4 bg-white rounded-full opacity-70 animate-sparkle"></div>
                                    <div className="absolute bottom-1/3 -left-2 w-3 h-3 bg-white rounded-full opacity-60 animate-sparkle-delay"></div>
                                </div>
                            </div>
                        </div>
                    </div>
